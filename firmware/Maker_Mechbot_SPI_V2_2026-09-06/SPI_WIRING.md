...
addresses the transport and recovery issues; sustained hardware operation still
needs verification. The wiring below is shared by both SPI builds.

V2 compilation passed on ESP32 core 3.3.11 / Adafruit BNO08x 1.2.7, along with
four host test programs. See the
[V2 build record](manifest.json).
...
[V2 upload and diagnosis instructions](FLASH_FROM_PC.md).
